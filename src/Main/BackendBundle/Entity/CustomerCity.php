 ...
 * @ORM\Entity(repositoryClass="Main\BackendBundle\Repository\CustomerCityRepository")
 */
class CustomerCity
{
    /**
     ...
     * @var int
     *
     * @ORM\ManyToOne(targetEntity="Customer", inversedBy="customerCities")
     ...
     * @var string
     *
     * @ORM\Column(name="city_breif", type="text")
     */
    private $cityBreif;
     ...
     * Set cityBreif.
     *
     * @param string $cityBreif
     *
     * @return CustomerCity
     */
    public function setCityBreif($cityBreif)
    {
        $this->cityBreif = $cityBreif;
     ...
     * @return string
     */
    public function getCityBreif()
    {
        return $this->cityBreif;
    }
